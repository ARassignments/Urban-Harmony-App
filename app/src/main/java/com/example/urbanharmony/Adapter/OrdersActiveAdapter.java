...
public class OrdersActiveAdapter extends RecyclerView.Adapter<OrdersActiveAdapter.ViewHolder>{
    ...
    public OrdersActiveAdapter(Context context, ArrayList<OrderModel> data) {
    ...
    @NonNull
    @Override
    public OrdersActiveAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_custom_listview, parent, false);
        // Passing view to ViewHolder
        OrdersActiveAdapter.ViewHolder viewHolder = new OrdersActiveAdapter.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull OrdersActiveAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int i) {
